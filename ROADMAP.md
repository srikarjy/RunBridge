...
Phases are implementation gates, not dates. **Only Phase 0 is complete in Stage 1.** Every later phase is planned. The first product slice is a human-driven nf-core/rnaseq proposal through Seqera / Nextflow, with deterministic authorization and PostgreSQL-backed execution evidence.
